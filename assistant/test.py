...
_classifier_init = [
    {
        ...
        user: 안녕?
        assistant: 네! 안녕하세요, 궁금하신 점이 있으신가요? 
        user: 오타니 쇼헤이에 대해 설명해줘.
        assistant: 오타니 쇼헤이는 메이저 리그에서 뛰는 일본 출신 선수로, 투수와 타자를 동시에 소화하는 '이도류'로 유명합니다. 그는 강력한 투구와 파워풀한 타격 능력으로 2021년 아메리칸 리그 MVP를 수상했습니다.
        user: 그의 현재 성적은 어때?
...
if __name__ == "__main__":
    asyncio.run(record_and_send_audio())
