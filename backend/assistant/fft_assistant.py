...
async def transcribe(websocket):
    ...
    if mean_value > threshold:
        ...
        filename_filtered = f"{now.hour}_{now.minute}_filtered.wav"
        ...
        write(filename_filtered, target_sample_rate, filtered_audio)
...
async def conversation(websocket):
    ...
    while True: 
        ...
        classifier = client.chat.completions.create(
            model="gpt-4o-mini", messages=classifier_init
        )
